...
<div class="container mt-5 pt-5 aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000">
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6 my-5">
      <div class="service-item">
        ...
        <p></p>
        <a href="services-single.html" btn-slide btn-medium btn-dark hover-slide-right text-uppercase mt-3>
    ...
    <div class="col-lg-4 col-md-6 my-5">
      <div class="service-item">
        <iconify-icon class="services-icon my-2" icon="material-symbols:shapes-outline">
          <style data-style="data-style"></style>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M8 17.95q.25.025.488.038T9 18t.513-.012t.487-.038V20h10V10h-2.05q.025-.25.038-.488T18 9t-.012-.513T17.95 8H20q.825 0 1.413.588T22 10v10q0 .825-.587 1.413T20 22H10q-.825 0-1.412-.587T8 20zM9 16q-2.925 0-4.962-2.037T2 9t2.038-4.962T9 2t4.963 2.038T16 9t-2.037 4.963T9 16m0-2q2.075 0 3.538-1.463T14 9t-1.463-3.537T9 4T5.463 5.463T4 9t1.463 3.538T9 14m0-5"/></svg>
        </iconify-icon>
        <h4 class=" fs-1">
          Building New Homes
        </h4>
    ...
    <div class="col-lg-4 col-md-6 my-5">
      <div class="service-item">
        <iconify-icon class="services-icon my-2" icon="icon-park-outline:road-one">
          <style data-style="data-style"></style>
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M8 6v36M24 6v4m0 10v8m0 10v4M40 6v36"/></svg>
        </iconify-icon>
        <h4 class=" fs-1">
          Building New Homes
        </h4>
